...
export class VisitorsComponent implements OnInit {
  ...
  initValues = {
      ...
      formDetails: [
        ...
        //   list:[
        //     {
        //       key: 'Am not happy with this Product',
        //       value: 'Am not happy with this Product'
        //     },
        //     {
        //       key: 'Not Worth for Money',
        //       value: 'Not Worth for Money'
        //     },
    ...
    header: ['SNo',"Date","Mobile Number","Language",'Service', 'Product',"Feedback","Comment"], 
  }
  customListDatas: {};
  ...
  async getAppointmentConversationList(searchData?) {
    ...
    if (appiyoError == '0') {
      ...
      this.visitorsList = [
        
        {
          ...
          "SNo": "3",
                ...
                "language":"English",
                "feedback":"Sad",
                "comment":"Not happy with this Product",
      ...
      this.customListDatas = {
        ...
        keys: ['SNo',"created_at",  'mobile_number', 'language','service','product','feedback','comment'],
      }
