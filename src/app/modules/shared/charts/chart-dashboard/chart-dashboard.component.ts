  ...
  async getOverall() {
    this.lineChartData = [{ data: [],
      ...
      const response: any = {
        ...
        "ErrorCode" : "",
        "ErrorMessage" : "",
        "ProcessId" : "e69865023fbd11ed86540242ac110002",
        "ProcessInstanceId" : "d4f6ee40408a11eda1f40242ac110002",
        "ProcessName" : "OverAllReport",
        "ProcessVariables" : {
           "corporateQuery" : "",
           "count" : "4",
           "count1" : 0,
           ...
           "marketQuery" : "",
           "productQuery" : "",
           "query" : "select count(id) as count from dashboard_reports        where is_active='1' and usecase='Digital_Factsheet' and cast(created_at as date) between        '2022-09-23' and '2022-09-30' ",
           "query_list" : [
              "select count(id) as count from dashboard_reports        where is_active='1' and usecase='Corporate_Deck' and cast(created_at as date) between        '2022-09-23' and '2022-09-30' ",
              "select count(id) as count from dashboard_reports        where is_active='1' and usecase='Market_Updates' and cast(created_at as date) between        '2022-09-23' and '2022-09-30' ",
              "select count(id) as count from dashboard_reports        where is_active='1' and usecase='Product_Info' and cast(created_at as date) between        '2022-09-23' and '2022-09-30' ",
              "select count(id) as count from dashboard_reports        where is_active='1' and usecase='Digital_Factsheet' and cast(created_at as date) between        '2022-09-23' and '2022-09-30' "
           ],
           "temp" : null,
           "tempCorporate" : "",
           "tempDigital" : "",
        ...
        "WorkflowId" : "0d2c9be43e4b11ed93000242ac110002",
        "currentCorrelationId" : "281475481442009",
        "customizedLogId" : "",
        "endedOn" : "2022-09-30T06:40:54.132137",
        ...
        "repoName" : "Mahindra",
        "rootCorrelationId" : "281475481442009",
        "startedOn" : "2022-09-30T06:40:54.097274"
     }
      ...
      },
      {
        ...
        this.lineChartLabels= ["Consent Report", "Service Report", "Products & offers", "Feedback Report"]
  ...
  async getOverallStack() {
    ...
    // this.enterpriseApiService.overallChart(params).subscribe(response => {
      const response: any = {
        ...
        "ErrorMessage" : "",
        "ProcessId" : "e69865023fbd11ed86540242ac110002",
        "ProcessInstanceId" : "e77af598408a11ed8d8e0242ac110002",
        "ProcessName" : "OverAllReport",
        "ProcessVariables" : {
           "corporateQuery" : "select count(id) as count from dashboard_reports                where is_active='1' and usecase='Corporate_Deck' and (month(created_at)='10')                and (year(created_at)='2021')",
           "count" : "",
           "count1" : 12,
           "count_list" : null,
           "digitalQuery" : "select count(id) as count from dashboard_reports                where is_active='1' and usecase='Digital_Factsheet' and (month(created_at)='10')                and (year(created_at)='2021')",
           "graphDateList" : [
              {
                 "CorporateDeck" : "10",
                 "DigitalFactsheet" : "12",
           ...
           "graphDateListCount" : "12",
           "marketQuery" : "select count(id) as count from dashboard_reports                where is_active='1' and usecase='Market_Updates' and (month(created_at)='10')                and (year(created_at)='2021')",
           "productQuery" : "select count(id) as count from dashboard_reports                where is_active='1' and usecase='Product_Info' and (month(created_at)='10')                and (year(created_at)='2021')",
           "query" : "",
           "query_list" : null,
           "temp" : {
              "graphDate" : "October",
        ...
        "Status" : "Execution Completed",
        "WorkflowId" : "0d2c9be43e4b11ed93000242ac110002",
        "currentCorrelationId" : "281475481442185",
        "customizedLogId" : "",
        "endedOn" : "2022-09-30T06:41:26.225265",
        "isWaitingForEvent" : false,
        "nodeBPMNId" : "3",
        "processId" : "e69865023fbd11ed86540242ac110002",
        "processName" : "OverAllReport",
        "repoId" : "62e263265c57c82568ad2c7b",
        "repoName" : "Mahindra",
        "rootCorrelationId" : "281475481442185",
        "startedOn" : "2022-09-30T06:41:25.161872"
     }
      const appiyoError = response?.Error;
      const apiErrorCode = response.ProcessVariables?.errorCode;
      const errorMessage = response.ProcessVariables?.errorMessage;
